...
export const CAR_MODEL_OPTIONS = [
  ...
  { key: "bmw", value: "bmw-ix", label: "bmw-ix" },
  { key: "bmw", value: "bmw-x7", label: "bmw-x7" },
  { key: "bmw", value: "bmw-x1", label: "bmw-x1" },
  { key: "bmw", value: "bmw-ix3", label: "bmw-ix3" },
  { key: "bmw", value: "bmw-i8", label: "bmw-i8" },
  { key: "ford", value: "Mustang", label: "Mustang" },
  { key: "ford", value: "Bronco", label: "Bronco" },
  { key: "ford", value: "Explorer", label: "Explorer" },
  { key: "ford", value: "F-150", label: "F-150" },
  { key: "ford", value: "Escape", label: "Escape" },
  { key: "ford", value: "Expedition", label: "Expedition" },
  { key: "tata", value: "Tiago", label: "Tiago" },
  { key: "tata", value: "Punch", label: "Punch" },
  { key: "tata", value: "Tigor", label: "Tigor" },
  { key: "tata", value: "Nexon", label: "Nexon" },
  { key: "tata", value: "Harrier", label: "Harrier" },
  { key: "tata", value: "Safar", label: "Safar" },
  { key: "audi", value: "sedans", label: "sedans" },
  { key: "audi", value: "hatchbacks", label: "hatchbacks" },
  { key: "audi", value: "coupes", label: "coupes" },
  { key: "audi", value: "convertibles", label: "convertibles" },
  { key: "audi", value: " SUVs", label: " SUVs" },
